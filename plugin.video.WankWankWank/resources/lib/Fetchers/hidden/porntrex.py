...
if __name__ == '__main__':
    category_id = IdGenerator.make_id('https://www.porntrex.com/categories/4k-porn/')
    channel_id = IdGenerator.make_id('https://www.porntrex.com/channels/watch4beauty/')
    porn_star_id = IdGenerator.make_id('https://www.porntrex.com/models/lexxxi-lockhart/')
    module = PornTrex()
