...
if __name__ == '__main__':
    category_id = IdGenerator.make_id('https://www.3movs.com/categories/big-tits/')
    porn_star_id = IdGenerator.make_id('https://www.3movs.com/pornstars/aiden-starr/')
    porn_star_sub_categories = (IdGenerator.make_id(('-4', 'A')),
                                IdGenerator.make_id('("(\'-4\', \'A\')", 2)'), porn_star_id)
    tag_id = IdGenerator.make_id('https://www.3movs.com/tags/arabian/')
    module = ThreeMovs()
    ...
    # module.download_object(module.objects['porn_stars']['obj'], porn_star_sub_categories, verbose=1)
