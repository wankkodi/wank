...
class DrTuber(PornFetcher):
    ...
    def __init__(self, source_name='DrTuber', source_id=0, store_dir='.', data_dir='../Data',
        ...
        """
        super(DrTuber, self).__init__(source_name, source_id, store_dir, data_dir, source_type, use_web_server,
                                      session_id)
    ...
    def _get_video_links_from_video_data_no_exception_check(self, video_data):
        ...
        params = prepare_json_from_not_formatted_text(config_data[0])
        headers = {
