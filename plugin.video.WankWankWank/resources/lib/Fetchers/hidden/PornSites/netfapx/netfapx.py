...
class Netfapx(PornFetcher):
    ...
    def __init__(self, source_name='Netfapx', source_id=0, store_dir='.', data_dir='../Data',
        ...
        """
        super(Netfapx, self).__init__(source_name, source_id, store_dir, data_dir, source_type, use_web_server,
                                      session_id)
    ...
    def _version_stack(self):
        return super(Netfapx, self)._version_stack + [self.__version]
