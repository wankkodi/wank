...
class PornDig(PornFetcher):
    ...
    def __init__(self, source_name='PornDig', source_id=0, store_dir='.', data_dir='../Data',
        ...
        """
        super(PornDig, self).__init__(source_name, source_id, store_dir, data_dir, source_type, session_id)
...
if __name__ == '__main__':
    # category_id = IdGenerator.make_id('/channels/91/arab')
    category_id = IdGenerator.make_id('/channels/46/bbw')
    amateur_category_id = IdGenerator.make_id('/channels/1131/arab-amateur')
    # pornstar_id = IdGenerator.make_id('/pornstars/90/lisa-ann.html')
    pornstar_id = IdGenerator.make_id('/pornstars/4770/peta-jensen.html')
    channel_id = IdGenerator.make_id('/studios/472/vivid.html')
    # channel_id = IdGenerator.make_id('/studios/164/wildgroupsex.html')
    # channel_id = IdGenerator.make_id('/studios/248/teenmegaworld.html')
    module = PornDig()
    # module.download_object(module.objects['categories']['obj'], (category_id, ), verbose=1)
    # module.download_object(module.objects['amateur_categories']['obj'], (amateur_category_id, ), verbose=1)
