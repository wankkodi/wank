...
class CumLouder(PornFetcher):
    ...
    def __init__(self, source_name='CumLouder', source_id=0, store_dir='.', data_dir='../Data',
        ...
        """
        super(CumLouder, self).__init__(source_name, source_id, store_dir, data_dir, source_type, session_id)
...
if __name__ == '__main__':
    category_id = IdGenerator.make_id('/porn-videos/anal/?show=cumlouder')
    channel_id = IdGenerator.make_id('/channel/evil-angel/')
    module = CumLouder()
