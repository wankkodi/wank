...
class SpankBang(PornFetcher):
    ...
    def __init__(self, source_name='SpankBang', source_id=0, store_dir='.', data_dir='../Data',
        ...
        """
        super(SpankBang, self).__init__(source_name, source_id, store_dir, data_dir, source_type, session_id)
...
if __name__ == '__main__':
    category_id = IdGenerator.make_id('/category/amateur/?order=trending')
    porn_star_id = IdGenerator.make_id('/1n/pornstar/eva+notty')
    module = SpankBang()
