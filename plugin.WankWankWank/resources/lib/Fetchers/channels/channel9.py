...
# Internet tools
from .. import urljoin, urlparse, unquote_plus
...
class Channel9(VODFetcher):
    ...
    def __init__(self, vod_name='Channel9', vod_id=-17, store_dir='.', data_dir='../../Data', source_type='VOD',
        ...
        super(Channel9, self).__init__(vod_name, vod_id, store_dir, data_dir, source_type, session_id)
    ...
    def _update_base_categories(self, base_object):
        ...
        for category in categories_trees:
            ...
            main_categories.append(CatalogNode(catalog_manager=self.catalog_manager,
                                               obj_id=link,
    ...
    def _get_episodes_show_object(self, show_object):
        ...
        episodes = [CatalogNode(catalog_manager=self.catalog_manager,
