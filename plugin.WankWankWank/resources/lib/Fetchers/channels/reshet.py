...
class Reshet(VODFetcher):
    ...
    def _get_show_seasons_from_show_data(self, show_raw_data, show_object):
        ...
        seasons = [CatalogNode(catalog_manager=self.catalog_manager,
                               obj_id=x['post_ID'],
                               title=x['title'],
                               url=urljoin(self.base_url, x['link']),
    ...
    def _get_episodes_from_season_object(self, season_object):
        ...
        episodes = [
            CatalogNode(catalog_manager=self.catalog_manager,
                        obj_id=y['post_ID'],
                        title=y['title'],
    ...
    def get_live_stream_info(self):
        ...
        return CatalogNode(catalog_manager=self.catalog_manager,
