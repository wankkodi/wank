...
class Sport1(VODFetcher):
    ...
    def _update_base_categories(self, base_object):
        ...
        main_objects = [CatalogNode(catalog_manager=self.catalog_manager,
    ...
    def _get_items_from_show_object(self, show_object):
        ...
        sub_objects = [CatalogNode(catalog_manager=self.catalog_manager,
                                   ...
                                   #                    main_raw_object[0].xpath('./div[@class="main-video"]//video_js/'
                                   #                                             'video/@poster')[0]),
        ...
        for x in raw_sub_objects:
            sub_objects.append(CatalogNode(catalog_manager=self.catalog_manager,
